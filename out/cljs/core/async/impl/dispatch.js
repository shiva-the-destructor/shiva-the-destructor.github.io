...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13565 = (0);while(true){
var m_13566 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13566 == null))
{} else
{m_13566.call(null);
if((count_13565 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13567 = (count_13565 + (1));
count_13565 = G__13567;
continue;
}
} else
{}
